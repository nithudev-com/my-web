...
export const metadata = { title: "Feed Rules | Google Merchant" };

export default async function FeedRulesPage() {
  const admin = await requireAdminSession();
  if (!admin) redirect("/admin/login");

  return (
    <div>
      <h1 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '24px' }}>Feed Rules</h1>
