  ...
  return (
    <div className="checkout-container">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .accordion-card { transition: all 0.3s ease; }
        .accordion-card:not(.active) { cursor: pointer; padding: 20px 32px; background: #fafafa; border-color: transparent; box-shadow: none; }
